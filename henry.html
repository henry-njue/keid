  ...
  <body>
    <nav class="navbar">
      <div class="navbar-container container">
          ...
          <ul class="menu-items">
              <li><a href="henry.html">Home</a></li>
              <li><a href="#about">About</a></li>
              <li><a href="#food">Category</a></li>
              <li><a href="#food-menu">Services</a></li>
              <li><a href="#testimonials">Testimonials</a></li>
              <li><a href="#contact">Contact US</a></li>
          </ul>
          <h1 class="logo">Henry</h1>
      </div>
  </nav>
    <section class="showcase-area" id="showcase">
      <div class="showcase-container">
        <h1 class="main-title" id="home">Accelerate Your Growth</h1>
        <p>Grow your Clientile with us, grow your business.</p>
        <a href="#food-menu" class="btn btn-primary">See Services</a>
      </div>
    </section>
    ...
    <section id="about">
      <div class="about-wrapper container">
        <div class="about-text">
          ...
          <h4>We are a trusted partner in promoting Businesses and start-up through online platforms and technology</h4>
          <p>

          </p>
        </div>
        <div class="about-img">
          <img src="img/techc.png" alt="food" />
        </div>
      </div>
    </section>
    <section id="food">
    ...
    <footer id="footer">
      <h2>Keivyle IT Solutions &copy;2024 all rights reserved</h2>
    </footer>
  </body>
  <!-- 
